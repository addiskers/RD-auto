...
def export_to_word(data, market_name, value_2023, currency, cagr, companies, output_path="Market_Report.docx"):
    ...
    text_paragraph = doc.add_paragraph()
    text_run = set_poppins_style(text_paragraph, size=12, color=RGBColor(0, 0, 0))
    text_run.text = f"Global {market_name} Market size was valued at USD {value_2023} {currency} in 2024 and is poised to grow from USD {value_2024} {currency} in 2025 to USD {value_2032} {currency} by 2033, growing at a CAGR of {cagr}% during the forecast period (2026-2033)."
