    ...
    if request.method == "POST":
        ...
        for heading, level in toc_content:
            if heading == "__INSERT_ITALIC_AFTER_KEY_DEVELOPMENTS__":
                ...
                run = p.add_run("The following companies are listed for indicative purposes only. Similar information will be provided for each, with detailed financial data available exclusively for publicly listed companies.")
                run.italic = True
            else:
